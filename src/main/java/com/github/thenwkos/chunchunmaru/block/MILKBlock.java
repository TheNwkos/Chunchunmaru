...
public class MILKBlock extends ChunchunmaruModElements.ModElement {
	@ObjectHolder("chunchunmaru:milk")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("chunchunmaru:milk_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public MILKBlock(ChunchunmaruModElements instance) {
		super(instance, 6);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes
						.builder(new ResourceLocation("chunchunmaru:blocks/milk_still"), new ResourceLocation("chunchunmaru:blocks/milk_moving"))
						.luminosity(0).density(1000).viscosity(1000).temperature(300).rarity(Rarity.RARE)
		...
		still = (FlowingFluid) new CustomFlowingFluid.Source(fluidproperties).setRegistryName("milk");
		flowing = (FlowingFluid) new CustomFlowingFluid.Flowing(fluidproperties).setRegistryName("milk_flowing");
		elements.blocks
		...
		elements.items.add(() -> new BucketItem(still,
				new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ChunItemGroup.tab).rarity(Rarity.RARE)) {
			@Override
			@OnlyIn(Dist.CLIENT)
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				super.addInformation(itemstack, world, list, flag);
				list.add(new StringTextComponent("ITS MILK GAMERS!"));
			}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("milk_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("chunchunmaru:milk_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
